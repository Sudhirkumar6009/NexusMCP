    ...
    <div className="min-h-screen bg-surface-primary flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <h1 className="text-4xl font-bold text-white leading-tight">
            Orchestrate your workflows<br />with intelligence.
          </h1>
          <p className="text-lg text-white/70 max-w-md">
            Connect your tools, automate complex processes, and let AI agents handle the rest.
          </p>
        </div>
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-4">
            ...
            <p className="text-white/70">
              <span className="text-white font-semibold">2,000+</span> teams already automating
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-content-primary mb-2">Welcome back</h2>
            <p className="text-content-secondary">Sign in to your account to continue</p>
          </div>
          ...
          <div className="flex items-center gap-4 my-6">
            ...
            <span className="text-content-secondary text-sm">or continue with email</span>
            <div className="flex-1 h-px bg-border" />
          </div>
          ...
          <div className="mt-8 lg:hidden text-center">
            <Link href="/" className="inline-flex items-center gap-2 text-content-secondary hover:text-content-primary transition-colors">
              <ArrowLeft className="w-4 h-4" />
              <span>Back to home</span>
            </Link>
          </div>
