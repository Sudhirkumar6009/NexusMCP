...
import { Zap, ArrowLeft, Mail, Lock, Eye, EyeOff, User, Check } from 'lucide-react';
    ...
    <div className="min-h-screen bg-surface-primary flex">
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-content-primary mb-2">Create your account</h2>
            <p className="text-content-secondary">Start your 14-day free trial</p>
          </div>
          ...
          <div className="flex items-center gap-4 my-6">
            ...
            <span className="text-content-secondary text-sm">or sign up with email</span>
            <div className="flex-1 h-px bg-border" />
          </div>
              ...
              {formData.password && (
                <div className="mt-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-content-secondary">{strength.text}</span>
                  </div>
                </div>
              )}
            </div>
