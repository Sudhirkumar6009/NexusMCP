              ...
              <div className="rounded-xl bg-surface-primary overflow-hidden">
                ...
                <div className="h-[500px] p-6 flex gap-6">
                  ...
                  <div className="w-56 shrink-0 rounded-xl bg-surface-secondary p-4 space-y-2">
                    {["Dashboard", "Integrations", "Workflows", "Logs"].map(
                      (item, i) => (
                        <div
                          key={item}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-content-secondary max-w-2xl mx-auto">
              Build complex workflows with natural language, visualize them as
              DAGs, and execute with full observability.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Describe what you want to automate in plain English. Our AI generates the workflow DAG automatically.",
              ...
              },
              {
                ...
                description:
                  "Interactive drag-and-drop editor to customize your workflows. See the data flow between each step.",
                color: "text-primary",
                bg: "bg-primary/10",
              },
              {
                ...
                description:
                  "Add human-in-the-loop checkpoints for critical operations. Full control over autonomous execution.",
      ...
      <section id="integrations" className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-content-secondary max-w-2xl mx-auto">
              Seamlessly integrate with popular services through the Model
              Context Protocol.
            </p>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-content-secondary mb-10 max-w-2xl mx-auto">
            Join thousands of teams using NexusMCP to connect their tools and
